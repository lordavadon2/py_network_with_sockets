...
if "nt" == os.name:
    root.wm_iconbitmap(bitmap="message_icon.ico")
else:
    root.wm_iconbitmap(bitmap="@message_icon.xbm")
...
send_button = tkinter.Button(input_frame, text="send", borderwidth=5, width=10, font=my_font, bg=light_green,
